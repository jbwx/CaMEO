 ...
 * Updated on 5/2/22 to account for Github name change (jw021 -> jbwx)
 */
    ...
    string previousName = "";
		...
		ifstream ifs(filename, ifstream::in);
          ...
          ofstream AllArticles("All-articles.html"); // each article added to All-articles.html
                ...
                AllArticles << "<hr><tt><a href=\"https://jbwx.github.io/CaMEO/index.html\" target=\"_self\">CaMEO</a> index page</tt><br><tt></p>" << '\n';
		  while (ifs.good()) {
		    ...
		    if(c == '\n'){ // if current char is newline
                ...
                switch (local){
                    ...
                    case 6: // Wikipedia link
                        ...
                        break;
                    case 7: // End
                         //generates the webpage. Yeah the code is ugly. It's HTML inside C++. I bet you don't see that everyday
                         //start make webpage
                                ...
                                MyFile << " <hr><tt><a href=\"https://jbwx.github.io/CaMEO/index.html\" target=\"_self\">CaMEO</a> index page</tt><br><tt><p style=\"border:1px; border-style:solid; border-color:#000000; padding: 0.5em; max-width: 50%;\"> <b>Mission information</b> " << '\n';
                                MyFile << " <br>Name: " + name << '\n';
